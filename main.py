...
from preprocessing_spotify import run_preprocessing
from label_crawler import run_label_crawler


def main(path_to_label_map=None, track_start=False, analysis=False, debug=False, skip_preprocessing = False):
    if track_start:
...
if __name__ == "__main__":
    ...
    try:
        ...
        print("PATH_TO_LABEL_MAP:", path_to_label_map)
        main(path_to_label_map, track_start, run_analysis, debug, skip_preprocessing)
